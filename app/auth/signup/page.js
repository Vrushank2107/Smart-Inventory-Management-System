...
export default function Register() {
  ...
  const handleSubmit = async (e) => {
    ...
    // Validate form data
    const validation = validateRequest(RegisterSchema, formData);
      ...
      <div className="w-full max-w-md px-4">
        <div className="glass-card bg-white/80 dark:bg-surface-800/80 backdrop-blur-md p-8 rounded-2xl shadow-xl border border-white/20 dark:border-surface-700/50">
          ...
          <div className="text-center mb-8">
            <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-primary-500 to-accent-600 rounded-2xl shadow-lg mb-4">
              <svg className="w-8 h-8 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 0112 0 4 4 0 018 0v1H3v-1z" />
              </svg>
            </div>
            ...
            <p className="text-surface-600 dark:text-surface-400 text-sm">
              Join Smart Inventory and start managing your inventory
            </p>
          </div>
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            {/* Password and Confirm Password Fields - Horizontal Layout */}
            <div className="grid grid-cols-2 gap-4">
              {/* Password Field */}
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                    className="block w-full pl-10 pr-10 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
